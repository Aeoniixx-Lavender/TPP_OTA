...
RELASE_TAG=PixelProject_${DEVICE}-${ROMTYPE}-${VERSION}
...
git commit -m "Update autogenerated json for The Pixel Project $VERSION $DEVICE"
git push

gh release create $RELASE_TAG $ROM --notes "Automated release for The Pixel Project $VERSION $DEVICE"
